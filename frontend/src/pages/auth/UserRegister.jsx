...
const UserRegister = () => {
  ...
  return (
    <AuthLayout title="Student Register">
      <form onSubmit={handleSubmit} className="flex flex-col gap-4">
        ...
        <div className="mt-4 text-center text-sm font-semibold text-slate-600 dark:text-slate-400">
          ...
          <Link to="/login" className="text-emerald-600 hover:text-emerald-700 dark:text-emerald-400 dark:hover:text-emerald-350 transition-colors">
            Log in here
          </Link>
        </div>
      </form>
